...
public class DragonFight {
	...
	int dragonAttack = 0;
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
	String attack = JOptionPane.showInputDialog("Would you like to yell or kick?");
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You have died to the dragon and have no treasure");
